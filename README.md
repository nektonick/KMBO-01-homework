...
- ### Дискретная математика:
    ...
    #### Текущее
    - Дз 6
        - Задача 2: решить [задачу](Ресурсы/Документы/3сем/hw6/max_matching_p/max_matching.pdf) (max_matching) [методом Куна](https://e-maxx.ru/algo/kuhn_matching) (до воскресенья)
        - Задача 3: решить [задачу](Ресурсы/Документы/3сем/hw6/max_matching_p/max_matching.pdf) (max_matching) алгоритмом Форда-Фалкерсона (до воскресенья)
        - [Задача 4](https://acmp.ru/index.asp?main=task&id_task=448) (на следующее занятие)
        - [Задача 5](Ресурсы/Документы/3сем/hw6/kubiki_p/kubiki.pdf) (на следующее занятие)
    ...
    - [Дз 7](Ресурсы/Документы/3сем/hw7.pdf) (на следующее занятие)
